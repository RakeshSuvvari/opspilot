...
test -s "${ROOT_DIR}/docs/screenshots/dashboard-overview.png"
test -s "${ROOT_DIR}/docs/screenshots/hitl-approval.png"
test -s "${ROOT_DIR}/docs/screenshots/remedy-success.png"
